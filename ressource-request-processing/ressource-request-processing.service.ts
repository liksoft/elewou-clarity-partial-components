...
import {
  ...
  deleteRessource,
  putRessource
} from 'src/app/lib/contracts/abstract-request-client';
import { HttpRequestService, IResponseBody } from 'src/app/lib/http/core';
import { ISerializableBuilder } from 'src/app/lib/built-value/contracts/serializers';
import { TranslationService } from 'src/app/lib/translator/translator.service';
